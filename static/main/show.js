			...
			<div class="mycard md-3 relative" id="${goodsValue.id}">
				...
				<div class="collapse" id="card_${goodsValue.id}">
					...
					<div class="modal-footer">
						<button id="cancel_2" data-toggle="collapse" data-target="#card_${goodsValue.id}" aria-expanded="false" aria-controls="card_${goodsValue.id}">取消</button>
						<button id="send_2" type="submit">完成</button>
					</div>
				</div>
			</div>
		`
